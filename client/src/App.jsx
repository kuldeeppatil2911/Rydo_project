...
function App() {
  ...
  if (loading) {
    return <div className="loading-screen">Loading Rydo project...</div>;
  }
      ...
      <header className="hero">
        <nav className="topbar">
          <div className="brand-lockup">
            ...
            <div>
              <p className="eyebrow">MERN Minor Project</p>
              <h1>Rydo</h1>
            </div>
          </div>
        ...
        <section className="hero-grid">
          <div className="hero-copy">
            <p className="hero-kicker">Fast. reliable. built for the city rush.</p>
            <h2>Book a ride, match with a driver, and track the trip with a real backend.</h2>
            <p className="hero-text">
              Rydo now runs as a MERN-stack project. The React frontend consumes Express APIs, stores bookings in
              MongoDB, and keeps the ride flow responsive and demo-ready.
            </p>
          ...
          <article className="card highlights-card">
            <div className="section-heading">
              <div>
                ...
                <h3>MERN architecture for your minor project</h3>
              </div>
            </div>
            <div className="highlights-grid">
              <div>
                <strong>MongoDB persistence</strong>
                <p>Drivers, locations, and bookings are modeled for storage and reuse through Mongoose schemas.</p>
              </div>
              <div>
                <strong>Express API design</strong>
                <p>Booking estimates, booking creation, status updates, and recent history flow through REST endpoints.</p>
              </div>
              <div>
                <strong>Responsive React UI</strong>
                <p>The client stays fast, accessible, and mobile friendly while consuming live backend data.</p>
              </div>
              <div>
                <strong>Demo-ready ride flow</strong>
                <p>Driver assignment, OTP generation, trip stages, and recent bookings support project presentation.</p>
              </div>
            </div>
          </article>
        </section>
